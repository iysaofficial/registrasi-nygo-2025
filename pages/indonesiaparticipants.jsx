...
export default function Internationalparticipants() {
  ...
  useEffect(() => {
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbzt21Df28x2qcpZ0yIgt0_Sdakkzpe2CsxD8p9KfkXMhj0tcjmr8boS0dYZlnTZXouC/exec";
      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HALLO PESERTA NYGO 2025, Mohon perhatikan informasi berikut ini
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="SUMBER_INFORMASI" className="form-label">
                    Sumber Informasi Kompetisi NYGO 2025
                  </label>
                  <select
                    type="text"
                    id="SUMBER_INFORMASI"
